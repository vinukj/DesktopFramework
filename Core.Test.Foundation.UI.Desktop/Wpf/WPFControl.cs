...
namespace Core.Test.Foundation.UI.Desktop.Wpf
{
    ...
    /// </summary>
    public class WPFControl : IWpfControl
    {
        /// <summary>
        ...
        public IList<IWpfControl> GetChilds(ControlRetry retry = ControlRetry.Avg, bool throwOnFail = true)
        {
            List<IWpfControl> childs = new List<IWpfControl>();
            ...
            foreach (var c in elements)
            {
                ...
                IWpfControl controls = controls = DesktopControlFactory.CreateWpf<WPFControl>(c, "Child-" + idx);
        ...
        public void CustomClick(ControlRetry retry = ControlRetry.Avg, bool throwOnFail = true)
        {
            ...
            MuiaControl control = new MuiaControl(native,ControlName);// Added the Control name Parametre
